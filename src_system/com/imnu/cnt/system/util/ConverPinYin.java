...
if(!validate(cnStr)){System.out.println("str err");
return cnStr;
 }
...
public static void main(String args[]){
	...
	try {
		...
		conn = DriverManager.getConnection("jdbc:sqlserver://116.113.104.54:1433;DatabaseName=psp", "sa", "anda1981");
		...
		while(rs.next()){
			...
			if(!StringUtils.isEmpty(account)){
				String str = account;
				System.out.println(account+"=>"+ConverPinYin.getFullSpell(str)+"=>"+ConverPinYin.getFirstSpell(str));
				String newAccount = ConverPinYin.getFullSpell(str);
//				stmt2.executeUpdate("update sys_user set ACCOUNT='"+newAccount+"' where USER_ID="+rs.getInt("USER_ID"));
//				conn.commit();
//				System.out.println();
//				String outputdir= javax.swing.filechooser.FileSystemView.getFileSystemView().getHomeDirectory().toString();
//				File outf = new File(outputdir+"//shuchu.txt");
//				FileWriter fw=null;
//				try {
//					 fw = new FileWriter(outf);
//					 fw.write(ConverPinYin.getFirstSpell(str)+"\n \t \r");
//					 fw.flush();
//					 fw.write(ConverPinYin.getFullSpell(str));
//					 fw.flush();
//					 fw.close();
//				} catch (IOException e) {
//					e.printStackTrace();
//				}
			...
			System.out.println((d.getTime() - new Date().getTime()) / 1000);
		}
	}
