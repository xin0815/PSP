...
<html lang="en">
	...
	<body>
		...
		<div class="alert alert-warning" role="alert"><h4>学校尚未发布当前年度贫困认定指标分配情况，请等待发布并再进行查询。</h4></div>
		</c:if>
		...
		<form action="poorDistribution/list" method="post" class="form-inline" id="PoorTargetForm">
			<div class="well form-search">
				<div class="form-group">
					<label>贫困认定年度</label>
					<input type="text" name="schoolYear.syname" class="form-control" value="${poorInfo.schoolYear.syname}" readonly="readonly" />
				</div>	
				<div class="form-group">
					<label>贫困认定名称</label>
