	...
	<body>
		...
		<table class="table table-bordered table-condensed table-striped">
		    ...
		    <tr>
			    ...
			    <td>${poolApplication.student.snation.name}</td>
		...
		<div class="form-group">
		    家庭困难佐证上传：
		    <c:if test="${not empty poolApplication.paevidence}"><a href="<%=basePath%>paevidence/${poolApplication.paevidence}">下载原家庭困难佐证文件</a></c:if>
  		</div>
		<div align="center">
