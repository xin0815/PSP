...
<html>
	...
	<body>
		...
		<form action="qtsubmit/importQualityTotaly" method="post" enctype="multipart/form-data" id="uploadForm">
			<input type="hidden" name="classId" value="${bc.cid }" /><br/>
			请单击此处，下载导入模板：<a href="<%=basePath%>template/QualityTotaly.xls" class="btn btn-info active" role="button">素质评价数据导入表模版</a>
			<br/>
			<br/>
