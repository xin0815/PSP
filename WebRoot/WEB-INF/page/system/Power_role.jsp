...
<html lang="true">
	...
	<script language="javascript">
		...
		function loadTree(id){
			...
			tree.loadXML("<%=path%>/power/downloadTree?id="+id+"&type=role");
			document.all._save_img.style.display = "";
		}
	</script>

	<body>
		<form action="power/pageUpdate" method="post" id="powerRoleForm">
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td width="75%" valign="top">
						<iframe id="left" name="left" src="power/findRole"
